...
function ShareScore(){
	...
	meta1='<meta property="og:title" content="A.N.G.E.L"/>';

	meta2='<meta property="og:description" content="ejemplo"/>';

	meta3='<meta property="og:image" content="../../img/memory_img.png"/>'

	$("head").append(meta1,meta2,meta3); 
...
function public_TW(){
	...
	var src='http:00angelgame.acostasite.com0Game0img0memory_img.png';
