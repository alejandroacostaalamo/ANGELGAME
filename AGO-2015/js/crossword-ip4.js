...
function validWord1(){
	...
	var answer1v = $("#input-0-10").val() + $("#input-1-10").val() + $("#input-2-10").val() + $("#input-3-10").val();
	if (answer1v == word1v){
...
function validWord2(){
	...
	var answer2h = $("#input-3-7").val() + $("#input-3-8").val() + $("#input-3-9").val() + $("#input-3-10").val();
	if (answer2h == word2h){
...
function validWord3(){
	...
	var answer3v = $("#input-3-8").val() + $("#input-4-8").val() + $("#input-5-8").val() + $("#input-6-8").val() + $("#input-7-8").val() + $("#input-8-8").val() + $("#input-9-8").val() + $("#input-10-8").val();
	if (answer3v == word3v){
		$("#cell-3-8").css("background-color","#17DB00");
...
function validWord4(){
	...
	var answer4h = $("#input-7-5").val() + $("#input-7-6").val() + $("#input-7-7").val() + $("#input-7-8").val();
	if (answer4h == word4h){
...
function validWord5(){
	...
	var answer5v = $("#input-7-16").val() + $("#input-8-16").val() + $("#input-9-16").val() + $("#input-10-16").val() + $("#input-11-16").val() + $("#input-12-16").val();
	if (answer5v == word5v){
...
function validWord6(){
	...
	var answer6h = $("#input-8-16").val() + $("#input-8-17").val() + $("#input-8-18").val();
	if (answer6h == word6h){
		$("#cell-8-16").css("background-color","#17DB00");
...
function validWord7(){
	...
	var answer7v = $("#input-9-5").val() + $("#input-10-5").val() + $("#input-11-5").val() + $("#input-12-5").val() + $("#input-13-5").val() + $("#input-14-5").val() + $("#input-15-5").val() + $("#input-16-5").val() + $("#input-17-5").val();
	if (answer7v == word7v){
...
function validWord8(){
	...
	var answer8v = $("#input-9-12").val() + $("#input-10-12").val() + $("#input-11-12").val() + $("#input-12-12").val();
	if (answer8v == word8v){
...
function validWord9(){
	...
	var answer9v = $("#input-9-14").val() + $("#input-10-14").val() + $("#input-11-14").val() + $("#input-12-14").val();
	if (answer9v == word9v){
...
function validWord10(){
	...
	var answer10h = $("#input-10-4").val() + $("#input-10-5").val() + $("#input-10-6").val() + $("#input-10-7").val() + $("#input-10-8").val() + $("#input-10-9").val() + $("#input-10-10").val() + $("#input-10-11").val() + $("#input-10-12").val() + $("#input-10-13").val() + $("#input-10-14").val() + $("#input-10-15").val() + $("#input-10-16").val();
...
function validWord11(){
	...
	var answer11h = $("#input-11-16").val() + $("#input-11-17").val() + $("#input-11-18").val() + $("#input-11-19").val();
...
function validWord12(){
	...
	var answer12v = $("#input-11-19").val() + $("#input-12-19").val();
...
function validWord13(){
	...
	var answer13h = $("#input-13-3").val() + $("#input-13-4").val() + $("#input-13-5").val() + $("#input-13-6").val();
...
function validWord14(){
	...
	var answer14v = $("#input-14-0").val() + $("#input-15-0").val() + $("#input-16-0").val() + $("#input-17-0").val();
...
function validWord15(){
	...
	var answer15h = $("#input-15-0").val() + $("#input-15-1").val() + $("#input-15-2").val() + $("#input-15-3").val() + $("#input-15-4").val() + $("#input-15-5").val() + $("#input-15-6").val() + $("#input-15-7").val();
...
function validWord16(){
	...
	var answer16h = $("#input-17-4").val() + $("#input-17-5").val() + $("#input-17-6").val() + $("#input-17-7").val();
...
function validWord17(){
	...
	var answer17v = $("#input-17-6").val() + $("#input-18-6").val() + $("#input-19-6").val();
...
function validWord18(){
	...
	var answer18h = $("#input-19-4").val() + $("#input-19-5").val() + $("#input-19-6").val();
